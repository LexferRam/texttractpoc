    ...
    return (
        <div className='mainContainer'>
            ...
            <ButtonsActions
                ...
                promptText={'obten la siguiente informacion de la imagen y retorna en formato JSON(valida realmente sea un carnet de circulación de venezuela, si no es un documento válido retorna el mensaje: "Documento inválido"): año del vehiculo, marca, modelo, placa, serial de motor(indicado arriba del nombre del titular), serial carroceria N.I.V o NIV, color del carro, destinado(ejemplo: particular etc), grupo(ejemplo: sport wagon, sedan etc), version(normalmente está jusnto con el modelo)'}
                capture={false}
            />
        </div>
    );
